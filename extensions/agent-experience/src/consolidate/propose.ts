...
import { EXPERIENCE_CLASSIFICATION_RUBRIC, EXPERIENCE_EVIDENCE_INSTRUCTIONS, EXPERIENCE_GENERALIZATION_INSTRUCTIONS, FRICTION_EXTRACTION_INSTRUCTIONS, GENERALIZED_HABIT_INSTRUCTIONS } from "./prompt.ts";
