...
- Added phase 23–31 package gates, packed Advisor/setup allowlists and peer checks, a fresh isolated-package verifier, real Pi PTY coverage for grouped setup plus collapsed/expanded approved-habit Advisor cards at wide and narrow widths, and OMP-native Advisor context/retention integration checks.
