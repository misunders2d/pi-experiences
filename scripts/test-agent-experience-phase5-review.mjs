...
try {
  ...
  assert.match(notes.at(-1).message, /experience review/);
  assert.doesNotMatch(notes.at(-1).message, /pending list|habit accept|capture on/);
  ...
  assert.match(notes.at(-1).message, /review accept/);
