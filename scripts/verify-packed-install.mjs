...
assert.ok(!packedFiles.some((path)=>/model_int8\.onnx|ort-wasm-simd-threaded\.wasm|observations\.jsonl|ledger\.sqlite|__pycache__|\.py[co]$|\.map$/.test(path)),'tarball must not contain model assets, private state, Python caches, or source maps');
