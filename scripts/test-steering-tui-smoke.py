...
state=Path(os.environ.get('AX_STATE_ROOT','/tmp/pi-experiences-046-steering-tui-state')).resolve()
runtime=state.parent/'pi-experiences-0.1.46-steering-runtime'
...
work=state.parent/'pi-experiences-0.1.46-steering-tui-work'; work.mkdir(parents=True,exist_ok=True)
