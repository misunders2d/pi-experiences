...
state=Path(os.environ.get('AX_STATE_ROOT','/tmp/pi-experiences-044-steering-tui-state')).resolve()
runtime=state.parent/'pi-experiences-0.1.44-steering-runtime'
...
work=state.parent/'pi-experiences-0.1.44-steering-tui-work'; work.mkdir(parents=True,exist_ok=True)
