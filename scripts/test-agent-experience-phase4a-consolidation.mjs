...
assert.deepEqual([...handlers.keys()].sort(), ['agent_end', 'agent_settled', 'before_agent_start', 'before_provider_request', 'context', 'input', 'message_end', 'message_start', 'model_select', 'session_before_compact', 'session_before_fork', 'session_before_switch', 'session_before_tree', 'session_compact', 'session_shutdown', 'session_start', 'session_tree', 'tool_execution_end', 'tool_execution_start', 'turn_end']);
