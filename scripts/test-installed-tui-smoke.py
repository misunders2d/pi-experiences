...
state=Path(os.environ.get('AX_STATE_ROOT','/tmp/pi-experiences-041-tui-smoke-state')).resolve(); state.mkdir(parents=True,exist_ok=True)
work=state.parent/'pi-experiences-0.1.41-tui-work'; work.mkdir(parents=True,exist_ok=True)
