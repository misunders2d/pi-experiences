...
state=Path(os.environ.get('AX_STATE_ROOT','/tmp/pi-experiences-035-tui-smoke-state')).resolve(); state.mkdir(parents=True,exist_ok=True)
work=state.parent/'pi-experiences-0.1.35-tui-work'; work.mkdir(parents=True,exist_ok=True)
